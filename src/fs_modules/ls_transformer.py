...
from src.layer_base import TransformerEmbeddingLayerBase
...
class LSTransformerModel(FairseqEncoderDecoderModel):
    ...
    def build_embedding(
        ...
        from src.torch_transformer_layers import TransformerEmbeddingLayer
...
class LSTransformerEncoder(FairseqEncoder):
    ...
    def build_encoder_layer(self, args):
        from src.torch_transformer_layers import TransformerEncoderLayer
...
class LSTransformerDecoder(FairseqIncrementalDecoder):
    ...
    def build_decoder_layer(self, args):
        from src.torch_transformer_layers import TransformerDecoderLayer
